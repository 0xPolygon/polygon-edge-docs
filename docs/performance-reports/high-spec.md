...
:::OOM
Some linux distros will automaticaly kill the process that has a very high RAM usage ( Out Of Memory error ) , in order to preserve the system stability.
The log output of this OOM error looks something like this:
```
