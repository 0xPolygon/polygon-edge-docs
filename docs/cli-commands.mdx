...
<Tabs>
  <TabItem value="syntax" label="Syntax" default>
    ...
    server [--speed-up SPEED_UP_MIN]

  </TabItem>
  <TabItem value="example" label="Example">

    server --speed-up 1000

  </TabItem>
</Tabs>

Sets the minimum amount of additional gas fee required to accelerate a same-nonce transaction. Default: `0`.
