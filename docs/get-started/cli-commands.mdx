...
<Tabs>
  ...
  <TabItem value="example" label="Example">
    ...
    server --max-inbound-peers 50

  </TabItem>
</Tabs>

Sets the client's maximum inbound peer count. Default: `40`.
...
<Tabs>
  ...
  <TabItem value="example" label="Example">
    ...
    server --max-outbound-peers 10

  </TabItem>
</Tabs>

Sets the client's maximum outbound peer count. Default: `10`.
