---
id: howto-enable-metrics
title: How to enable prometheus metrics 
---
...
Prometheus metrics are disabled by default. It can be enabled by specifying the listener address using `-prometheus` flag or Telemetrics.prometheus field in config file. 
Metrics will be serverd under `/metrics` on the specified address.
